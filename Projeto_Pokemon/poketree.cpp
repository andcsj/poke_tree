    ...
    void inserirPorCSV(const string& caminho, int limite) {
        ...
        while (getline(arquivo, linha) && contador < limite) {
            ...
            try {
                ...
                adicionarCarta(std::make_shared<Carta>(id, nome, JogoTipo::POKEMON, poder, resistencia, tipos, rating));
                contador++;
...
int main() {
    ...
    do {
        ...
        cout << "\n=== EXIBIR CARTAS ===\n";
        cout << "3. Exibir Estrutura da Árvore AVL\n";
        cout << "4. Exibir Top 20 Cartas por Rating\n";
        cout << "5. Exibir Todas as Cartas\n";
        cout << "\n=== BUSCAR CARTAS ===\n";
        cout << "6. Buscar por ID\n";
        cout << "7. Buscar por Nome\n";
        cout << "8. Buscar por Rating\n";
        cout << "\n=== OUTRAS OPÇÕES ===\n";
        cout << "9. Verificar Quantidade de Cartas\n";
        cout << "10. Montar BST por Rating\n";
        cout << "11. Destruir Árvore AVL\n";
        cout << "12. Exibir Estatísticas\n";
        cout << "13. Exportar cartas para CSV\n";
        cout << "0. Sair\n";
        cout << "Escolha: ";
        
        while (true) {
            cin >> opcao;
            if (opcao >= 0 && opcao <= 13) break;
            cout << "Opção inválida. Digite um número entre 0 e 13: ";
            cin.clear();
            cin.ignore(numeric_limits<streamsize>::max(), '\n');
        }
        cin.ignore();
